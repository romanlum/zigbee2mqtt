...
class Group {
    constructor(groupID, members) {
        ...
        this.removeFromNetwork =  function(){};
...
class Endpoint {
    constructor(ID, inputClusters, outputClusters, deviceIeeeAddress, binds=[], clusterValues={}) {
        ...
        this.command = function(){};
        this.commandResponse =  function(){};
        this.read =  function(){};
        this.write =  function(){};
        this.bind =  function(){};
        this.unbind =  function(){};
        this.save = function(){};
        this.configureReporting = function(){};
        this.meta = {};
        this.binds = binds;
...
const mock = {
    setTransmitPower:  function(){},
    touchlinkFactoryReset:  function(){},
    touchlinkFactoryResetFirst: function(){},
    touchlinkScan: function(){},
    touchlinkIdentify: function(){},
    start:  function(){},
    permitJoin:  function(){},
    getCoordinatorVersion: function(){return ({type: 'z-Stack', meta: {version: 1, revision: 20190425}})},
    getNetworkParameters:  function(){return {panID: 0x162a, extendedPanID: [0, 11, 22], channel: 15}},
    on: (type, handler) => {
        events[type] = handler;
    },
    stop:  function(){},
